...
public final class EraPaletteCorpusHarness {
    ...
    public static void main(String[] args) throws Exception {
        ...
        expected.put("E01-010", List.of(
            "TERRAIN", "TOOLSTONE_PROXIES", "SPOIL", "ORGANIC_DIGGING_TOOL_TRACES", "FORBIDDEN_BASE_MATERIALS"
        ));
        ...
        expected.put("E01-014", List.of(
            "HEAVY_BONE_FRACTURED_BONE_ROLE", "ANVIL_HAMMERSTONE_ROLE", "SMALL_FRACTURE_DEBRIS_ROLE",
            "PROCESSING_STAIN_GROUND_DISTURBANCE_ROLE", "OPTIONAL_HEARTH_TRACE"
        ));
        expected.put("E01-015", List.of(
            "OPENED_SPENT_HEAVY_BONE_ROLE", "LIGHT_PERCUSSION_TOOL_ROLE", "SPENT_FRAGMENT_DEBRIS_ROLE",
            "ORGANIC_GREASE_GROUND_DISTURBANCE_ROLE", "OPTIONAL_SUBORDINATE_HEARTH_TRACE"
        ));
