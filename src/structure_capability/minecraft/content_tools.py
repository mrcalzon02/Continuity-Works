...
class MinecraftContentTools:
    ...
    def book(self, request: dict) -> dict:
        ...
        author = str(request.get("author") or "Continuity Works")
    ...
    def loot_table(self, request: dict) -> dict:
        profile = self._profile(request)
        version = profile.normalized
        table_id = _resource_id(request.get("table_id") or request.get("id") or "continuityworks:generated_loot", request.get("namespace") or "continuityworks")
        policy = str(request.get("id_policy") or "namespace")
    ...
    def recipe(self, request: dict) -> dict:
        profile = self._profile(request)
        version = profile.normalized
        recipe_id = _resource_id(request.get("recipe_id") or request.get("id") or "continuityworks:generated_recipe", request.get("namespace") or "continuityworks")
    ...
    def advancement(self, request: dict) -> dict:
        profile = self._profile(request)
        version = profile.normalized
        advancement_id = _resource_id(request.get("advancement_id") or request.get("id") or "continuityworks:generated_advancement", request.get("namespace") or "continuityworks")
        policy = str(request.get("id_policy") or "namespace")
        ...
        if display:
            ...
            description = display.get("description", "Generated by Continuity Works")
    ...
    def tag(self, request: dict) -> dict:
        profile = self._profile(request)
        version = profile.normalized
        tag_id = _resource_id(request.get("tag_id") or request.get("id") or "continuityworks:generated_tag", request.get("namespace") or "continuityworks")
    ...
    def datapack_manifest(self, request: dict) -> dict:
        ...
        description = request.get("description") or "Generated by Continuity Works"
    ...
    def package(self, request: dict, structure_result: dict | None = None) -> dict:
        profile = self._profile(request)
        version = profile.normalized
        package_id = _resource_id(request.get("package_id") or request.get("id") or "continuityworks:generated_package", request.get("namespace") or "continuityworks")
        policy = str(request.get("id_policy") or "namespace")
        ...
        manifest_request.setdefault("description", f"Continuity Works package {package_id}")
    ...
    def assign_icon(self, request: dict) -> dict:
        ...
        default_item, default_label = self.SEMANTIC_ICONS.get(subject, ("minecraft:knowledge_book", subject[:2].upper() or "CW"))
